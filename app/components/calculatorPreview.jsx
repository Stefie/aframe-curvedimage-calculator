  ...
  render() {
    ...
    return (
      <Scene>
        ...
        <a-text value='loading...' color='#21897C' align='center' position='0 1 -3' scale='3 3 1'  visible={loading} >
          <a-animation attribute="scale" easing="linear" dur="800" direction="alternate" repeat="indefinite" from="3 3  1" to="3.1 3.1 1"></a-animation>
        </a-text>
